...
@ControllerAdvice
public class SurrenderCylinderExceptionController extends ResponseEntityExceptionHandler{
//
...
//	}
	...
	public ResponseEntity<SurrenderCylinderException> handleGlobalException(Exception exception, WebRequest webRequest) {
		SurrenderCylinderException errorDetails = new SurrenderCylinderException(new Date(), exception.getMessage(),
